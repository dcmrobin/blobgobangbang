...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    [Header("References")]
    //public LobbyController lobbyControllerScript;
    public Text usrnmText;
    ...
    private void Start()
    {
        lob = GameObject.Find("LobbyController");
        PV = GetComponent<PhotonView>();
        if (!PV.IsMine) {
            this.enabled=false;
        }
        usrnmText.text = lob.GetComponent<LobbyController>().usertext.text;
    ...
    private void Update()
    {
        //usrnmText.text =  SceneThang.GameObject.lobbyControllerObj.GetComponent<LobbyController>().username.text;
        if (PV.IsMine)
        {
